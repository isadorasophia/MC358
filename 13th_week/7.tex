...
Descreva como modelar em grafos o problema de se encontrar um circuito equino num tabuleiro ou decidir que não existe um.

\solution
  Para modelar o problema em grafos, basta considerá-lo como um grafo de $nm$ vértices bipartido, em grupos $V_1$ e $V_2$ análogos à distribuição de cores do tabuleiro (o cavalo sempre avança para cores diferentes no tabuleiro). Assim, para decidir se não existe um circuito equino, basta checar o número de vértices - se for ímpar, não há como o grafo ser hamiltoniano (propriedade de um grafo bipartido).
