...
\problem{8.}
  Quantos grafos \textit{não-isomorfos} com 4 vértices existem?

\solution
  Há: grafo com 0 arestas (1), grafo com 1 aresta (1), grafos com 2 arestas (2), grafos com 3 arestas (3),  grafos com 4 arestas (2) e grafos com 5 arestas (2) = 11 grafos.
\end{document}
