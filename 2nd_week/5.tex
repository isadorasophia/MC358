...
\problem{5.}
Encontre uma fórmula usando apenas os conectivos $ \lnot $ e $ \rightarrow $ que seja equivalente a $ P \leftrightarrow Q $.
...
\solution
  ...
  Assim, utilizando a propriedade de que $p \rightarrow q$ é equivalente a $\lnot p \lor q$:

  \begin{equation}
    \lnot(\lnot(P \rightarrow Q) \lor \lnot(Q \rightarrow P)) = \lnot((P \rightarrow Q) \rightarrow \lnot(Q \rightarrow P))
  \end{equation}
